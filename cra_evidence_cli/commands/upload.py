...
def upload_sbom(
    ...
    You can upload an existing SBOM file with --file, generate one from a container
    image with --image, or scan a source directory with --source. Generation uses
    the verified engine bundled in supported installs or selected by
    CRA_EVIDENCE_ENGINE or PATH.
        ...
        if docker_image:
            ...
            try:
                ...
                if product_type and product_type.lower() == "hardware":
                    err_console.print(
                        "\n[yellow]Warning:[/yellow] SBOM generated by the CRA Evidence "
                        "engine from a hardware filesystem. "
                        ...
                        "For containers and software, embedded Syft cataloguing provides "
                        "good coverage."
                    )
